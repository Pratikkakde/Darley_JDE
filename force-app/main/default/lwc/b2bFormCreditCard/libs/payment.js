...
let cards = [
    ...
    {
        type: "maestro",
        pattern: /^(5018|5020|5033|5038|5641|5868|6304|6703|6708|6759|676[1-3])/,
        format: defaultFormat,
...
const formatCardNumber = maxLength =>
    function(e) {
        ...
        if (card && card.type === "AmericanExpress") {
            // AmericanExpress cards are formatted differently
            re = /^(\d{4}|\d{4}\s\d{6})$/;
        } else {
            re = /(?:^|\s)(\d{4})$/;
        }
...
const restrictCombinedExpiry = e => restrictExpiry(e, 4);

const restrictMonthExpiry = e => restrictExpiry(e, 2);

const restrictYearExpiry = e => restrictExpiry(e, 2);
